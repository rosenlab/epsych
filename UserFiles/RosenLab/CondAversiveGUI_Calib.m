...
% Last Modified by GUIDE v2.5 02-Jun-2015 13:43:15
...
% --- Executes on button press in calib_radio.
function calib_radio_Callback(hObject, eventdata, handles)
% hObject    handle to calib_radio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global traintype
set(handles.MaskAlone_radio,'value',0);
set(handles.VaryToneDur_radio,'value',0); 
set(handles.VaryToneLevel_radio,'value',0);
if get(handles.calib_radio,'value');
traintype = 'calibration';
end
 
% Hint: get(hObject,'Value') returns toggle state of calib_radio
